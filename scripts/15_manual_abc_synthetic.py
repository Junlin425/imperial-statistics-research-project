"""Run Manual-summary rejection ABC on the stored synthetic SV series."""
...
def run_synthetic_experiment(
    ...
    """Run and save the formal synthetic-data Manual ABC experiment."""

    if input_path is None:
        input_path = script_output("synthetic_sv_returns.npy")
    if sample_path is None:
        sample_path = script_output("abc_manual_synthetic_sv.npy")
