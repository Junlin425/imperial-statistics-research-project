"""Run adaptive Manual-summary ABC-SMC on the synthetic SV dataset."""
...
def run_synthetic_experiment(
    ...
    """Run and save one synthetic-data ABC-SMC experiment."""

    if input_path is None:
        input_path = SCRIPT_DIR / "synthetic_sv_returns.npy"
    if output_prefix is None:
        output_prefix = SCRIPT_DIR / "abc_smc_synthetic_sv"
    ...
    if (
        ...
        raise ValueError("synthetic returns must be a finite vector")
